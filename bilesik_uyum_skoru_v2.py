"""
BILESIK UYUM SKORU v2 - KGS KALITE KONTROLLU (25.09.2026)
============================================================
...
Cikti: data/backtest/bilesik_uyum_skoru_v2_sonuc.json
"""
import json
import datetime
...
def main():
    ...
    rapor = {
        "calisma": "Bilesik Uyum Skoru v2 - KGS Kalite Kontrollu",
        ...
        "v1den_degisiklik": (
            "60-gunluk getiri bileseni KALDIRILDI (52-hafta zirve ile "
            "asiri korelasyonlu oldugu icin - kullanicinin dogru "
            "gozlemi). KGS kalite kontrolu EKLENDI - fiyat zayifligina "
            "ragmen KGS COK dusukse (<40) ayri bir uyari bayragi "
            "kaldiriliyor, 'saglikli dip' ile 'gercekten bozulan hisse' "
            "ayirt edilmeye calisiliyor."
        ),
        "durustluk_notu": (
    ...
    with open("data/backtest/bilesik_uyum_skoru_v2_sonuc.json", "w", encoding="utf-8") as f:
    ...
    print("\nTamamlandi -> data/backtest/bilesik_uyum_skoru_v2_sonuc.json")
